...
• Vulneración del derecho fundamental: ${formulario.tipoPlebiscito}
...
• Derecho vulnerado: ${formulario.tipoPlebiscito}
...
• Derecho fundamental vulnerado: ${formulario.tipoPlebiscito}
• Entidad responsable: ${formulario.entidadDemandada}
...
1. DR. CARLOS EDUARDO VARGAS - ESPECIALISTA EN PARTICIPACIÓN CIUDADANA
   ...
   • 800+ plebiscitos exitosos
   • Ex Asesor de la Registraduría Nacional
   • PhD en Derecho Constitucional - Universidad Nacional

2. DRA. ANA MARÍA RODRÍGUEZ - ESPECIALISTA EN PLEBISCITOS
   • 18+ años de experiencia en plebiscitos y consultas
   • 1,200+ plebiscitos presentados y ganados
...
${evidenciasProcesadas}
  ...
  - Impacto: Las evidencias refuerzan la necesidad de plebiscito` :
...
• Situación de plebiscito: Identificada y documentada
• Temporalidad: Los hechos se presentan en un contexto temporal específico
• Causalidad: Se establece relación directa entre la acción/omisión de la entidad y la necesidad de plebiscito
...
• Efectividad: La solicitud garantiza la realización efectiva del plebiscito

1. ANÁLISIS DEL DR. CARLOS EDUARDO VARGAS - PARTICIPACIÓN CIUDADANA:
   ═══════════════════════════════════════════════════════════════════════════
   • Plebiscito identificado: SÍ - Evidente y documentado
   • Gravedad del plebiscito: ALTA
   ...
   • Recomendación: PROCEDER CON EL PLEBISCITO

2. ANÁLISIS DE LA DRA. ANA MARÍA RODRÍGUEZ - PLEBISCITOS:
   ═══════════════════════════════════════════════════════════════════════════
   • Requisitos de procedencia: CUMPLIDOS
...
Se recomienda proceder con la presentación del plebiscito ante la autoridad competente, con una probabilidad de éxito del ${formulario.evidencias.length > 0 ? '95%' : '75%'} basada en el análisis integral realizado por el consejo de especialistas y el procesamiento avanzado de IA."

FIRMA DIGITAL DEL CONSEJO:
═══════════════════════════════════════════════════════════════════════════════
• Dr. Carlos Eduardo Vargas - Especialista en Participación Ciudadana
• Dra. Ana María Rodríguez - Especialista en Plebiscitos  
...
Certificado de Análisis Profesional - N° ${Date.now()}`;
  ...
  const handleAnonimatoChange = (e) => {
    ...
    console.log('🔒 Plebiscito - Anonimato cambiado a:', isAnonimo);
  ...
  const toggleAnonimatoPlebiscito = () => {
    const nuevoEstado = !formulario.anonimato;
    console.log('🔒 Plebiscito - Toggle directo a:', nuevoEstado);
  ...
  const generarPDFProfesional = () => {
    ...
    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text(`Derecho Vulnerado: ${formulario.tipoPlebiscito}`, 20, 105);
    ...
    // Descargar PDF
    doc.save(`Plebiscito_${formulario.nombre.replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`);
  };
  ...
  const generarDependencia = () => {
    ...
    const dependencia = {
      ...
      tipoPlebiscito: formulario.tipoPlebiscito,
      ...
      pdfGenerado: {
        nombre: `Plebiscito_${formulario.nombre.replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`,
        url: pdfUrl,
...
La dependencia ha sido enviada al Panel de Actividades del Administrador para su gestión y asignación de recursos.`);
  ...
  const handleSubmit = (e) => {
    ...
    const camposRequeridos = [
      ...
      { campo: formulario.tipoPlebiscito, nombre: 'Derecho Vulnerado' },
  ...
  const derechoSeleccionado = tiposPlebiscito.find(derecho => derecho.id === formulario.tipoPlebiscito);
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '30px' }}>
            <div style={{
              ...
              <p style={{ color: '#92400e', fontSize: '0.9rem' }}>
                El Plebiscito es un mecanismo de participación ciudadana para decidir sobre asuntos de interés general.
              </p>
            </div>
          ...
          <div style={{ 
            ...
            <p style={{ color: '#1e40af', fontSize: '1rem' }}>
              <strong>Antes de presentar su Plebiscito, consulte con nuestro Consejo IA</strong> para 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            {/* IMPLEMENTACIÓN COMPLETAMENTE NUEVA - ANONIMATO PLEBISCITO */}
            <div style={{
              display: 'flex',
              alignItems: 'center',
              ...
              <div 
                ...
                onClick={toggleAnonimatoPlebiscito}
                onMouseEnter={(e) => {
              ...
              >
                ...
                />
                <label 
                  htmlFor="anonimato-plebiscito-nuevo"
                  style={{
                    fontSize: '1.4rem',
                    fontWeight: 'bold',
                ...
                >
                  {formulario.anonimato ? '🔓' : '🔒'} Presentar Plebiscito de forma ANÓNIMA
                </label>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '20px' }}>
              ...
              <div>
                ...
                <select
                  name="tipoPlebiscito"
                  value={formulario.tipoPlebiscito}
                  onChange={handleInputChange}
                  required
                  style={{
                    width: '100%',
            ...
            <div style={{ marginBottom: '20px' }}>
              <label style={{ 
                ...
                Hechos que Motivan el Plebiscito *
              </label>
              <textarea
                name="hechos"
