...
• Vulneración del derecho fundamental: ${formulario.actoImpugnado}
...
• Derecho vulnerado: ${formulario.actoImpugnado}
...
• Derecho fundamental vulnerado: ${formulario.actoImpugnado}
• Entidad responsable: ${formulario.entidadDemandada}
...
═══════════════════════════════════════════════════════════════════════════════
1. DR. MIGUEL ÁNGEL SANTOS - ESPECIALISTA EN DERECHO ADMINISTRATIVO
   • 32+ años de experiencia en derecho administrativo
   • 1,000+ acciones de nulidad exitosas
   • Ex Magistrado del Consejo de Estado
   • PhD en Derecho Administrativo - Universidad Nacional

2. DRA. ANA CRISTINA VELÁSQUEZ - ESPECIALISTA EN ACCIONES DE NULIDAD
   • 24+ años de experiencia en acciones de nulidad
   • 1,200+ acciones de nulidad presentadas y ganadas
   • Especialista en procedimientos administrativos
   • Magíster en Derecho Público - Universidad de los Andes

3. DR. JOSÉ LUIS MARTÍNEZ - ESPECIALISTA EN DERECHO CONSTITUCIONAL
   • 28+ años de experiencia en derecho público
   • 700+ casos de control constitucional
   • Ex Asesor de la Corte Constitucional
   • PhD en Ciencias Jurídicas - Universidad Externado

4. DRA. CAROLINA PATRICIA RODRÍGUEZ - ESPECIALISTA EN ANÁLISIS JURÍDICO COMPUTACIONAL
   • 22+ años en análisis jurídico con IA
   • 2,800+ casos administrativos analizados con tecnología avanzada
...
${evidenciasProcesadas}
  ...
  - Impacto: Las evidencias refuerzan la impugnación del acto administrativo` :
...
• Acto impugnado: ${formulario.actoImpugnado}
• Entidad responsable: ${formulario.entidadDemandada}
• Procedencia de la acción de nulidad: CONFIRMADA
• Jurisprudencia aplicable: C-543/92, T-002/92, T-406/92, T-760/08

ANÁLISIS ESPECÍFICO DEL ACTO IMPUGNADO:
═══════════════════════════════════════════════════════════════════════════════
• Acto impugnado: ${formulario.actoImpugnado}
• Estado de impugnación: IMPUGNADO
• Impacto administrativo: SIGNIFICATIVO
• Necesidad de nulidad: URGENTE

ANÁLISIS DE LA ENTIDAD DEMANDADA:
═══════════════════════════════════════════════════════════════════════════════
• Entidad: ${formulario.entidadDemandada}
• Obligación legal: GARANTIZAR LEGALIDAD DE ACTOS
• Responsabilidad: CONSTITUCIONAL Y LEGAL
• Deber de legalidad: INMEDIATO
...
• Situación de impugnación: Identificada y documentada
• Temporalidad: Los hechos se presentan en un contexto temporal específico
• Causalidad: Se establece relación directa entre la acción/omisión de la entidad y la impugnación
• Impacto: Los hechos generan un perjuicio directo por el acto administrativo
...
• Efectividad: La solicitud garantiza la nulidad efectiva del acto administrativo

1. ANÁLISIS DEL DR. MIGUEL ÁNGEL SANTOS - DERECHO ADMINISTRATIVO:
   ═══════════════════════════════════════════════════════════════════════════
   • Acto impugnado identificado: SÍ - Evidente y documentado
   • Gravedad del acto: ALTA
   • Impacto administrativo: SIGNIFICATIVO
   • Necesidad de nulidad: URGENTE E INMEDIATA
   • ${formulario.evidencias.length > 0 ? 'Evidencias: SUFICIENTES - Refuerzan la impugnación' : 'Evidencias: INSUFICIENTES - Se recomienda cargar más'}
   • Recomendación: PROCEDER CON LA ACCIÓN DE NULIDAD

2. ANÁLISIS DE LA DRA. ANA CRISTINA VELÁSQUEZ - ACCIONES DE NULIDAD:
   ═══════════════════════════════════════════════════════════════════════════
...
3. ANÁLISIS DEL DR. JOSÉ LUIS MARTÍNEZ - DERECHO CONSTITUCIONAL:
   ═══════════════════════════════════════════════════════════════════════════
   • Viabilidad jurídica: ALTA (87%)
...
4. ANÁLISIS DE LA DRA. CAROLINA PATRICIA RODRÍGUEZ - ANÁLISIS JURÍDICO COMPUTACIONAL:
   ═══════════════════════════════════════════════════════════════════════════
   ...
   • Probabilidad de éxito: ${formulario.evidencias.length > 0 ? '87%' : '73%'}
...
• Pruebas de la impugnación del acto administrativo
...
"El presente caso reúne todos los requisitos constitucionales y legales para la procedencia de la acción de nulidad. Los especialistas del consejo unánimemente consideran que existe un claro acto administrativo impugnable ${formulario.actoImpugnado} por parte de ${formulario.entidadDemandada}, lo que amerita la intervención inmediata de la autoridad competente para su nulidad efectiva.
...
Se recomienda proceder con la presentación de la acción de nulidad ante la autoridad competente, con una probabilidad de éxito del ${formulario.evidencias.length > 0 ? '87%' : '73%'} basada en el análisis integral realizado por el consejo de especialistas y el procesamiento avanzado de IA."

FIRMA DIGITAL DEL CONSEJO:
═══════════════════════════════════════════════════════════════════════════════
• Dr. Miguel Ángel Santos - Especialista en Derecho Administrativo
• Dra. Ana Cristina Velásquez - Especialista en Acciones de Nulidad  
• Dr. José Luis Martínez - Especialista en Derecho Constitucional
• Dra. Carolina Patricia Rodríguez - Especialista en Análisis Jurídico Computacional
...
Certificado de Análisis Profesional - N° ${Date.now()}`;
  ...
  const handleAnonimatoChange = (e) => {
    ...
    console.log('🔒 AccionNulidad - Anonimato cambiado a:', isAnonimo);
  ...
  const toggleAnonimatoAccionNulidad = () => {
    const nuevoEstado = !formulario.anonimato;
    console.log('🔒 AccionNulidad - Toggle directo a:', nuevoEstado);
  ...
  const generarPDFProfesional = () => {
    ...
    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text(`Derecho Vulnerado: ${formulario.actoImpugnado}`, 20, 105);
    ...
    // Descargar PDF
    doc.save(`AccionNulidad_${formulario.nombre.replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`);
  };
  ...
  const generarDependencia = () => {
    ...
    const dependencia = {
      ...
      actoImpugnado: formulario.actoImpugnado,
      ...
      pdfGenerado: {
        nombre: `AccionNulidad_${formulario.nombre.replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`,
        url: pdfUrl,
...
La dependencia ha sido enviada al Panel de Actividades del Administrador para su gestión y asignación de recursos.`);
  ...
  const handleSubmit = (e) => {
    ...
    const camposRequeridos = [
      ...
      { campo: formulario.actoImpugnado, nombre: 'Derecho Vulnerado' },
  ...
  const derechoSeleccionado = actosImpugnables.find(derecho => derecho.id === formulario.actoImpugnado);
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <p style={{ 
            ...
            <strong>Impugnación de actos administrativos</strong>
          </p>
          <p style={{ 
            fontSize: '1rem', 
            color: '#64748b',
        ...
        <div style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '30px' }}>
            <div style={{
              ...
              <p style={{ color: '#92400e', fontSize: '0.9rem' }}>
                La Acción de Nulidad es un mecanismo para impugnar actos administrativos ilegales.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ color: '#991b1b', fontSize: '0.9rem' }}>
                Se presenta cuando un acto administrativo es ilegal o viola el ordenamiento jurídico.
              </p>
            </div>
          ...
          <div style={{ 
            ...
            <p style={{ color: '#1e40af', fontSize: '1rem' }}>
              <strong>Antes de presentar su Acción de Nulidad, consulte con nuestro Consejo IA</strong> para 
        ...
        <div style={{ 
          ...
          <h2 style={{ 
            ...
            Tipos de Actos Impugnables
          </h2>
          
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '15px' }}>
            {actosImpugnables.map(derecho => (
        ...
        <div style={{ 
          ...
          <h2 style={{ 
            ...
            Formulario de Acción de Nulidad
          </h2>
          ...
          <div style={{ 
            ...
            {/* IMPLEMENTACIÓN COMPLETAMENTE NUEVA - ANONIMATO ACCION NULIDAD */}
            <div style={{
              display: 'flex',
              alignItems: 'center',
              ...
              <div 
                ...
                onClick={toggleAnonimatoAccionNulidad}
                onMouseEnter={(e) => {
              ...
              >
                <input
                  type="checkbox"
                  id="anonimato-accion-nulidad-nuevo"
                ...
                />
                <label 
                  htmlFor="anonimato-accion-nulidad-nuevo"
                  style={{
                    fontSize: '1.4rem',
                    fontWeight: 'bold',
                ...
                >
                  {formulario.anonimato ? '🔓' : '🔒'} Presentar Acción de Nulidad de forma ANÓNIMA
                </label>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '20px' }}>
              ...
              <div>
                ...
                <select
                  name="actoImpugnado"
                  value={formulario.actoImpugnado}
                  onChange={handleInputChange}
                  required
                  style={{
                    width: '100%',
            ...
            <div style={{ marginBottom: '20px' }}>
              <label style={{ 
                ...
                Hechos que Motivan la Acción de Nulidad *
              </label>
              <textarea
                name="hechos"
