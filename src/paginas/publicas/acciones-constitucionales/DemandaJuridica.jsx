  ...
  const tiposDemandas = [
    {
      ...
      descripcion: 'Controversias sobre derechos civiles y patrimoniales',
      articulo: 'Código Civil'
    },
    {
      id: 'comercial',
      nombre: 'Demanda Comercial',
      descripcion: 'Controversias sobre actos de comercio y contratos',
      articulo: 'Código de Comercio'
    },
    {
      id: 'laboral',
      nombre: 'Demanda Laboral',
      descripcion: 'Controversias sobre relaciones laborales y prestaciones',
      articulo: 'Código Sustantivo del Trabajo'
    },
    {
      id: 'familia',
      nombre: 'Demanda de Familia',
      descripcion: 'Controversias sobre derecho de familia y menores',
      articulo: 'Código de la Infancia y la Adolescencia'
    },
    {
      id: 'administrativo',
      nombre: 'Demanda Administrativa',
      descripcion: 'Controversias con entidades públicas',
      articulo: 'Código de Procedimiento Administrativo'
    },
    {
      id: 'penal',
      nombre: 'Demanda Penal',
      descripcion: 'Acciones penales y reparación de daños',
      articulo: 'Código Penal'
    },
    {
      id: 'tributario',
      nombre: 'Demanda Tributaria',
      descripcion: 'Controversias sobre obligaciones tributarias',
      articulo: 'Estatuto Tributario'
    },
    {
      id: 'inmobiliario',
      nombre: 'Demanda Inmobiliaria',
      descripcion: 'Controversias sobre bienes inmuebles y propiedad',
      articulo: 'Código Civil'
    }
  ];
...
• Vulneración del derecho fundamental: ${formulario.tipoDemanda}
...
• Derecho vulnerado: ${formulario.tipoDemanda}
...
• Derecho fundamental vulnerado: ${formulario.tipoDemanda}
• Entidad responsable: ${formulario.entidadDemandada}
...
"El presente caso reúne todos los requisitos para la procedencia de la acción de tutela, configurando una clara vulneración del derecho fundamental a [derecho específico] por parte de [entidad], lo que amerita la intervención inmediata del juez constitucional."`;
  ...
  const analisisUnificadoIA = async () => {
    ...
    setTimeout(() => {
      ...
      const analisisUnificado = `ANÁLISIS UNIFICADO PROFESIONAL - CONSEJO DE ESPECIALISTAS EN DERECHO PROCESAL
================================================================================

CONSEJO DE ESPECIALISTAS CERTIFICADOS:
═══════════════════════════════════════════════════════════════════════════════
1. DR. RAFAEL ANTONIO GONZÁLEZ - ESPECIALISTA EN DERECHO PROCESAL
   • 30+ años de experiencia en derecho procesal
   • 1,200+ demandas jurídicas exitosas
   • Ex Magistrado de la Corte Suprema de Justicia
   • PhD en Derecho Procesal - Universidad Nacional

2. DRA. LUCÍA MARÍA TORRES - ESPECIALISTA EN DEMANDAS JURÍDICAS
   • 22+ años de experiencia en demandas jurídicas
   • 1,500+ demandas presentadas y ganadas
   • Especialista en procedimientos judiciales
   • Magíster en Derecho Procesal - Universidad de los Andes

3. DR. CARLOS ENRIQUE VEGA - ESPECIALISTA EN DERECHO CIVIL
   • 26+ años de experiencia en derecho civil
   • 800+ casos de derecho civil
   • Ex Asesor del Consejo de Estado
   • PhD en Derecho Civil - Universidad Externado

4. DRA. PATRICIA ALEJANDRA MENDOZA - ESPECIALISTA EN ANÁLISIS JURÍDICO COMPUTACIONAL
   • 20+ años en análisis jurídico con IA
   • 2,500+ casos procesales analizados con tecnología avanzada
   • Especialista en procesamiento de documentos judiciales
...
${evidenciasProcesadas}
  ...
  - Impacto: Las evidencias refuerzan la vulneración de derechos` :
...
• Impacto: Los hechos generan un perjuicio directo a los derechos
• Urgencia: La situación requiere intervención inmediata del juez competente
...
• Efectividad: La solicitud garantiza la protección efectiva de los derechos

1. ANÁLISIS DEL DR. RAFAEL ANTONIO GONZÁLEZ - DERECHO PROCESAL:
   ═══════════════════════════════════════════════════════════════════════════
   ...
   • Recomendación: PROCEDER CON LA DEMANDA JURÍDICA

2. ANÁLISIS DE LA DRA. LUCÍA MARÍA TORRES - DEMANDAS JURÍDICAS:
   ═══════════════════════════════════════════════════════════════════════════
...
3. ANÁLISIS DEL DR. CARLOS ENRIQUE VEGA - DERECHO CIVIL:
   ═══════════════════════════════════════════════════════════════════════════
   • Viabilidad jurídica: ALTA (85%)
   ...
   • Impacto civil: POSITIVO
   • Recomendación: CASO SÓLIDO PARA PRESENTAR

4. ANÁLISIS DE LA DRA. PATRICIA ALEJANDRA MENDOZA - ANÁLISIS JURÍDICO COMPUTACIONAL:
   ═══════════════════════════════════════════════════════════════════════════
   ...
   • Probabilidad de éxito: ${formulario.evidencias.length > 0 ? '85%' : '70%'}
...
OBSERVACIÓN 1 - DR. RAFAEL ANTONIO GONZÁLEZ:
"Los hechos descritos configuran una clara vulneración de derechos, requiriendo intervención inmediata del juez competente para su protección. ${formulario.evidencias.length > 0 ? 'Las evidencias cargadas y procesadas por IA fortalecen significativamente el caso, proporcionando una base probatoria sólida.' : 'Se recomienda cargar evidencias adicionales para mayor solidez del caso.'} La entidad demandada tiene la obligación legal de garantizar estos derechos."

OBSERVACIÓN 2 - DRA. LUCÍA MARÍA TORRES:
"La solicitud debe ser específica y medible, incluyendo plazos razonables para el cumplimiento y medidas de seguimiento. ${formulario.archivoConsejoIA ? 'El archivo Consejo IA ha sido procesado e integrado al análisis, proporcionando contexto adicional valioso que enriquece la fundamentación del caso.' : 'Se sugiere cargar archivo Consejo IA para un análisis más completo y fundamentación adicional.'} El caso reúne todos los requisitos de procedencia para la demanda jurídica."

OBSERVACIÓN 3 - DR. CARLOS ENRIQUE VEGA:
"El caso presenta fundamentos constitucionales sólidos y jurisprudencia favorable que respalda la procedencia de la demanda jurídica. ${formulario.evidencias.length > 0 ? 'La documentación procesada respalda completamente los fundamentos legales.' : 'Se requiere documentación adicional para respaldar los fundamentos.'} La viabilidad jurídica es alta y el impacto civil será positivo."

OBSERVACIÓN 4 - DRA. PATRICIA ALEJANDRA MENDOZA:
...
• Pruebas de la vulneración de derechos
...
"El presente caso reúne todos los requisitos constitucionales y legales para la procedencia de la demanda jurídica. Los especialistas del consejo unánimemente consideran que existe una clara vulneración de derechos en el tipo de demanda ${formulario.tipoDemanda} por parte de ${formulario.entidadDemandada}, lo que amerita la intervención inmediata del juez competente para su protección efectiva.
...
Se recomienda proceder con la presentación de la demanda jurídica ante el juez competente, con una probabilidad de éxito del ${formulario.evidencias.length > 0 ? '85%' : '70%'} basada en el análisis integral realizado por el consejo de especialistas y el procesamiento avanzado de IA."

FIRMA DIGITAL DEL CONSEJO:
═══════════════════════════════════════════════════════════════════════════════
• Dr. Rafael Antonio González - Especialista en Derecho Procesal
• Dra. Lucía María Torres - Especialista en Demandas Jurídicas  
• Dr. Carlos Enrique Vega - Especialista en Derecho Civil
• Dra. Patricia Alejandra Mendoza - Especialista en Análisis Jurídico Computacional
...
Certificado de Análisis Profesional - N° ${Date.now()}`;
  ...
  const handleAnonimatoChange = (e) => {
    ...
    console.log('🔒 DemandaJuridica - Anonimato cambiado a:', isAnonimo);
  ...
  const toggleAnonimatoDemandaJuridica = () => {
    const nuevoEstado = !formulario.anonimato;
    console.log('🔒 DemandaJuridica - Toggle directo a:', nuevoEstado);
  ...
  const generarPDFProfesional = () => {
    ...
    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text(`Derecho Vulnerado: ${formulario.tipoDemanda}`, 20, 105);
    ...
    // Descargar PDF
    doc.save(`DemandaJuridica_${formulario.nombre.replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`);
  };
  ...
  const generarDependencia = () => {
    ...
    const dependencia = {
      id: Date.now(),
      tipo: 'DemandaJuridica',
      solicitante: formulario.nombre,
      documento: formulario.documento,
      email: formulario.email,
      telefono: formulario.telefono,
      direccion: formulario.direccion,
      tipoDemanda: formulario.tipoDemanda,
      ...
      pdfGenerado: {
        nombre: `DemandaJuridica_${formulario.nombre.replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`,
        url: pdfUrl,
...
La dependencia ha sido enviada al Panel de Actividades del Administrador para su gestión y asignación de recursos.`);
  ...
  const handleSubmit = (e) => {
    ...
    const camposRequeridos = [
      ...
      { campo: formulario.tipoDemanda, nombre: 'Derecho Vulnerado' },
  ...
  const derechoSeleccionado = tiposDemandas.find(derecho => derecho.id === formulario.tipoDemanda);
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <p style={{ 
            ...
            <strong>Proceso judicial ordinario para reclamar derechos</strong>
          </p>
          <p style={{ 
            fontSize: '1rem', 
            color: '#64748b',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '30px' }}>
            <div style={{
              ...
              <p style={{ color: '#92400e', fontSize: '0.9rem' }}>
                La Demanda Jurídica es un proceso judicial ordinario para reclamar derechos civiles, comerciales o laborales.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ color: '#991b1b', fontSize: '0.9rem' }}>
                Se presenta cuando hay controversia sobre derechos civiles, comerciales o laborales.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ color: '#065f46', fontSize: '0.9rem' }}>
                Requiere abogado, se presenta ante el juez competente, con formalidades procesales.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ color: '#3730a3', fontSize: '0.9rem' }}>
                El juez tiene plazos amplios para resolver, generalmente 6 meses a 2 años.
              </p>
            </div>
          </div>
        ...
        <div style={{ 
          ...
          <h2 style={{ 
            ...
            Formulario de Demanda Jurídica
          </h2>
          ...
          <div style={{ 
            ...
            {/* IMPLEMENTACIÓN COMPLETAMENTE NUEVA - ANONIMATO DEMANDA JURIDICA */}
            <div style={{
              display: 'flex',
              alignItems: 'center',
              ...
              <div 
                ...
                onClick={toggleAnonimatoDemandaJuridica}
                onMouseEnter={(e) => {
              ...
              >
                <input
                  type="checkbox"
                  id="anonimato-demanda-juridica-nuevo"
                ...
                />
                <label 
                  htmlFor="anonimato-demanda-juridica-nuevo"
                  style={{
                    fontSize: '1.4rem',
                    fontWeight: 'bold',
                ...
                >
                  {formulario.anonimato ? '🔓' : '🔒'} Presentar Demanda Jurídica de forma ANÓNIMA
                </label>
              </div>
            </div>
...
export default DemandaJuridica;
