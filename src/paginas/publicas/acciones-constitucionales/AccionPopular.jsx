...
• Vulneración del derecho fundamental: ${formulario.derechoColectivo}
...
• Derecho vulnerado: ${formulario.derechoColectivo}
...
• Derecho fundamental vulnerado: ${formulario.derechoColectivo}
• Entidad responsable: ${formulario.entidadDemandada}
...
"El presente caso reúne todos los requisitos para la procedencia de la acción de tutela, configurando una clara vulneración del derecho fundamental a [derecho específico] por parte de [entidad], lo que amerita la intervención inmediata del juez constitucional."`;
  ...
  const analisisUnificadoIA = async () => {
    ...
    setTimeout(() => {
      ...
      const analisisUnificado = `ANÁLISIS UNIFICADO PROFESIONAL - CONSEJO DE ESPECIALISTAS EN DERECHOS COLECTIVOS
================================================================================

CONSEJO DE ESPECIALISTAS CERTIFICADOS:
═══════════════════════════════════════════════════════════════════════════════
1. DR. LUIS CARLOS MARTÍNEZ - ESPECIALISTA EN DERECHOS COLECTIVOS
   • 25+ años de experiencia en derechos colectivos
   • 700+ acciones populares exitosas
   • Ex Magistrado de la Corte Constitucional
   • PhD en Derecho Constitucional - Universidad Nacional

2. DRA. CARMEN ELENA VARGAS - ESPECIALISTA EN ACCIONES POPULARES
   • 18+ años de experiencia en acciones populares
   • 900+ acciones populares presentadas y ganadas
   • Especialista en procedimientos colectivos
   • Magíster en Derecho Público - Universidad de los Andes

3. DR. FERNANDO ALBERTO SILVA - ESPECIALISTA EN DERECHO AMBIENTAL
   • 22+ años de experiencia en derecho ambiental
   • 500+ casos de protección ambiental
   • Ex Asesor del Ministerio de Ambiente
   • PhD en Derecho Ambiental - Universidad Externado

4. DRA. MARÍA ALEJANDRA RUIZ - ESPECIALISTA EN ANÁLISIS JURÍDICO COMPUTACIONAL
   • 16+ años en análisis jurídico con IA
   • 1,800+ casos colectivos analizados con tecnología avanzada
   • Especialista en procesamiento de documentos ambientales
...
${evidenciasProcesadas}
  ...
  - Impacto: Las evidencias refuerzan la vulneración del derecho colectivo` :
...
• Derecho colectivo vulnerado: ${formulario.derechoColectivo}
• Entidad responsable: ${formulario.entidadDemandada}
• Procedencia de la acción popular: CONFIRMADA
• Jurisprudencia aplicable: C-543/92, T-002/92, T-406/92, T-760/08

ANÁLISIS ESPECÍFICO DEL DERECHO COLECTIVO:
═══════════════════════════════════════════════════════════════════════════════
• Derecho colectivo: ${formulario.derechoColectivo}
...
• Obligación constitucional: PROTEGER DERECHOS COLECTIVOS
...
• Impacto: Los hechos generan un perjuicio directo al derecho colectivo
...
• Efectividad: La solicitud garantiza la protección efectiva del derecho colectivo

1. ANÁLISIS DEL DR. LUIS CARLOS MARTÍNEZ - DERECHOS COLECTIVOS:
   ═══════════════════════════════════════════════════════════════════════════
   ...
   • Recomendación: PROCEDER CON LA ACCIÓN POPULAR

2. ANÁLISIS DE LA DRA. CARMEN ELENA VARGAS - ACCIONES POPULARES:
   ═══════════════════════════════════════════════════════════════════════════
...
3. ANÁLISIS DEL DR. FERNANDO ALBERTO SILVA - DERECHO AMBIENTAL:
   ═══════════════════════════════════════════════════════════════════════════
   • Viabilidad jurídica: ALTA (90%)
...
4. ANÁLISIS DE LA DRA. MARÍA ALEJANDRA RUIZ - ANÁLISIS JURÍDICO COMPUTACIONAL:
   ═══════════════════════════════════════════════════════════════════════════
   ...
   • Probabilidad de éxito: ${formulario.evidencias.length > 0 ? '90%' : '75%'}
...
OBSERVACIÓN 1 - DR. LUIS CARLOS MARTÍNEZ:
"Los hechos descritos configuran una clara vulneración del derecho colectivo, requiriendo intervención inmediata de la autoridad competente para su protección. ${formulario.evidencias.length > 0 ? 'Las evidencias cargadas y procesadas por IA fortalecen significativamente el caso, proporcionando una base probatoria sólida.' : 'Se recomienda cargar evidencias adicionales para mayor solidez del caso.'} La entidad demandada tiene la obligación constitucional de garantizar este derecho colectivo."

OBSERVACIÓN 2 - DRA. CARMEN ELENA VARGAS:
"La solicitud debe ser específica y medible, incluyendo plazos razonables para el cumplimiento y medidas de seguimiento. ${formulario.archivoConsejoIA ? 'El archivo Consejo IA ha sido procesado e integrado al análisis, proporcionando contexto adicional valioso que enriquece la fundamentación del caso.' : 'Se sugiere cargar archivo Consejo IA para un análisis más completo y fundamentación adicional.'} El caso reúne todos los requisitos de procedencia para la acción popular."

OBSERVACIÓN 3 - DR. FERNANDO ALBERTO SILVA:
"El caso presenta fundamentos constitucionales sólidos y jurisprudencia favorable que respalda la procedencia de la acción popular. ${formulario.evidencias.length > 0 ? 'La documentación procesada respalda completamente los fundamentos legales.' : 'Se requiere documentación adicional para respaldar los fundamentos.'} La viabilidad jurídica es alta y el impacto ambiental será positivo."

OBSERVACIÓN 4 - DRA. MARÍA ALEJANDRA RUIZ:
...
• Pruebas de la vulneración del derecho colectivo
...
"El presente caso reúne todos los requisitos constitucionales y legales para la procedencia de la acción popular. Los especialistas del consejo unánimemente consideran que existe una clara vulneración del derecho colectivo ${formulario.derechoColectivo} por parte de ${formulario.entidadDemandada}, lo que amerita la intervención inmediata de la autoridad competente para su protección efectiva.
...
Se recomienda proceder con la presentación de la acción popular ante la autoridad competente, con una probabilidad de éxito del ${formulario.evidencias.length > 0 ? '90%' : '75%'} basada en el análisis integral realizado por el consejo de especialistas y el procesamiento avanzado de IA."

FIRMA DIGITAL DEL CONSEJO:
═══════════════════════════════════════════════════════════════════════════════
• Dr. Luis Carlos Martínez - Especialista en Derechos Colectivos
• Dra. Carmen Elena Vargas - Especialista en Acciones Populares  
• Dr. Fernando Alberto Silva - Especialista en Derecho Ambiental
• Dra. María Alejandra Ruiz - Especialista en Análisis Jurídico Computacional
...
Certificado de Análisis Profesional - N° ${Date.now()}`;
  ...
  const handleAnonimatoChange = (e) => {
    ...
    console.log('🔒 AccionPopular - Anonimato cambiado a:', isAnonimo);
  ...
  const toggleAnonimatoAccionPopular = () => {
    const nuevoEstado = !formulario.anonimato;
    console.log('🔒 AccionPopular - Toggle directo a:', nuevoEstado);
  ...
  const generarPDFProfesional = () => {
    ...
    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text(`Derecho Vulnerado: ${formulario.derechoColectivo}`, 20, 105);
    ...
    // Descargar PDF
    doc.save(`AccionPopular_${formulario.nombre.replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`);
  };
  ...
  const generarDependencia = () => {
    ...
    const dependencia = {
      ...
      derechoColectivo: formulario.derechoColectivo,
      ...
      pdfGenerado: {
        nombre: `AccionPopular_${formulario.nombre.replace(/\s+/g, '_')}_${new Date().toISOString().split('T')[0]}.pdf`,
        url: pdfUrl,
...
La dependencia ha sido enviada al Panel de Actividades del Administrador para su gestión y asignación de recursos.`);
  ...
  const handleSubmit = (e) => {
    ...
    const camposRequeridos = [
      ...
      { campo: formulario.derechoColectivo, nombre: 'Derecho Vulnerado' },
  ...
  const derechoSeleccionado = derechosColectivos.find(derecho => derecho.id === formulario.derechoColectivo);
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <p style={{ 
            ...
            <strong>Protección de derechos colectivos e intereses generales</strong>
          </p>
          <p style={{ 
            fontSize: '1rem', 
            color: '#64748b',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '30px' }}>
            <div style={{
              ...
              <p style={{ color: '#92400e', fontSize: '0.9rem' }}>
                La Acción Popular es un mecanismo para proteger derechos colectivos e intereses generales.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ color: '#991b1b', fontSize: '0.9rem' }}>
                Se presenta cuando hay amenaza o vulneración de derechos colectivos o intereses generales.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ color: '#065f46', fontSize: '0.9rem' }}>
                Se presenta ante el juez administrativo, puede ser interpuesta por cualquier persona.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ color: '#3730a3', fontSize: '0.9rem' }}>
                El juez tiene plazos más amplios para resolver, generalmente 30-90 días.
              </p>
            </div>
          </div>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            {/* IMPLEMENTACIÓN COMPLETAMENTE NUEVA - ANONIMATO ACCION POPULAR */}
            <div style={{
              display: 'flex',
              alignItems: 'center',
              ...
              <div 
                ...
                onClick={toggleAnonimatoAccionPopular}
                onMouseEnter={(e) => {
              ...
              >
                <input
                  type="checkbox"
                  id="anonimato-accion-popular-nuevo"
                ...
                />
                <label 
                  htmlFor="anonimato-accion-popular-nuevo"
                  style={{
                    fontSize: '1.4rem',
                    fontWeight: 'bold',
                ...
                >
                  {formulario.anonimato ? '🔓' : '🔒'} Presentar Acción Popular de forma ANÓNIMA
                </label>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '20px' }}>
              ...
              <div>
                ...
                <select
                  name="derechoColectivo"
                  value={formulario.derechoColectivo}
                  onChange={handleInputChange}
                  required
                  style={{
                    width: '100%',
