      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Catálogo y gestión de derechos fundamentales de las comunidades étnicas de Colombia
              </p>
            </div>
          </div>
          ...
          <Alert className="mb-6">
            ...
            <AlertDescription>
              Este sistema protege y difunde los derechos fundamentales de las comunidades étnicas reconocidos por la Constitución y el derecho internacional.
            </AlertDescription>
          </Alert>
        </div>
